...
macro(hermetic_malloc_setup)
  ...
  if(HERMETIC_MALLOC AND NOT HERMETIC_MALLOC STREQUAL "system")
    ...
    elseif(_hm_tgt_OS STREQUAL "windows" AND HERMETIC_RESOLVED_WINDOWS_ABI STREQUAL "gnu")
      hermetic_fatal("HERMETIC_MALLOC: Windows targets on the GNU ABI use the UCRT as a DLL (ucrtbase.dll), whose heap no linking can replace; use the MSVC ABI with the static C runtime (CMAKE_MSVC_RUNTIME_LIBRARY=MultiThreaded)")
