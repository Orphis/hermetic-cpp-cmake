...
if(HERMETIC_LLVM_DRY_RUN)
  ...
  elseif(tgt_OS STREQUAL "wasm")
    message(STATUS "target:    ${HERMETIC_LLVM_TARGET} (${tgt_TRIPLE}), freestanding")
    message(STATUS "runtimes:  ${HERMETIC_LLVM_TARGET}-none in ${HERMETIC_LLVM_CACHE_DIR}/runtimes/${sel_VERSION}/")
  elseif(tgt_OS STREQUAL "darwin" AND (NOT HERMETIC_LLVM_SYSROOT OR HERMETIC_LLVM_SYSROOT MATCHES "^(default|sdk)$"))
    hermetic_llvm_macos_sdk_versions(versions default)
    hermetic_llvm_select_version("macOS SDK (HERMETIC_LLVM_MACOS_SDK_VERSION)" "${HERMETIC_LLVM_MACOS_SDK_VERSION}" "${default}" "${versions}" sdk_version)
    message(STATUS "target:    ${HERMETIC_LLVM_TARGET} (${tgt_TRIPLE})")
    message(STATUS "macOS SDK: ${sdk_version} in ${HERMETIC_LLVM_CACHE_DIR}/macos/")
  else()
    message(STATUS "target:    ${HERMETIC_LLVM_TARGET} (${tgt_TRIPLE})")
  endif()
